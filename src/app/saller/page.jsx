...
//    const res =await  fetch("http://localhost:4000/arival",{
//         method : "POST",
//         headers: {
//             "content-type" : "application/json"
//         },
//         body:JSON.stringify(fashion_card)
//      })
...
const handleAdd = async (e) => {
  ...
  try {
    ...
    formData.append("upload_preset", "fiasco");

    const cloudinaryRes = await fetch(
      "https://api.cloudinary.com/v1_1/dd7qkkle2/image/upload",
      {
        method: "POST",
        body: formData,
      }
